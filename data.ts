...
export const PROJECTS: Project[] = [
  ...
  // 2. Ad Creator
  {
    ...
    role: 'System Architect',
    impact_summary: 'Ad spend scaled 4x with no creative team. $150K to $600K per month.',
  ...
  // 3. Enterprise Content Intelligence Infrastructure
  {
    ...
    subtitle: 'Automated thought leadership engine for senior partners at a global consulting firm.',
    client: 'Global Consulting Firm, TMT Practice',
    role: 'System Architect',
    impact_summary: 'LinkedIn pipeline automated from research to post drafts. 50+ senior partners live inside multi-million dollar consulting pitches.',
  ...
  // 5. B2B Lead Intelligence & Outbound Pipeline
  {
    ...
    subtitle: 'End-to-end outbound pipeline for qualified, outreach-ready leads.',
    client: 'Industrial Software Platform (QHSE, EHS, CMMS, ESG)',
    role: 'System Architect',
    impact_summary: 'Hyper-personalized copy for qualified leads at bulk scale. 500 outreach-ready leads per run in three languages.',
  ...
  // 6. EMS Manufacturing LinkedIn Content System
  {
    ...
    role: 'System Architect',
    impact_summary: 'End-to-end LinkedIn content engine for industrial brands.',
  ...
  // 7. Viral Content Intelligence and Playbook System
  {
    ...
    subtitle: 'Social intelligence engine that turns top content into viral playbooks.',
    client: 'Boom & Wisdom',
    role: 'Developer',
    impact_summary: 'Viral content across 6 platforms, zero manual research. Raw social data turned into production-ready playbooks.',
  ...
  // 9. Content Strategy Agent
  {
    ...
    subtitle: 'Approval-gated editorial pipeline with automated SEO enrichment.',
    client: 'XpertLink',
    role: 'Developer',
    impact_summary: '300+ article backlog triaged by AI search score. SEO outline drafts in under 10 minutes.',
  ...
  // 10. Aliyah Lead Scraping
  {
    ...
    role: 'Developer',
    impact_summary: 'False positives cut from 80% to under 10%. Lead qualification down from days to hours.',
  ...
  // 11. Teknova Lead Journey
  {
    ...
    client: 'Teknova',
    role: 'Developer',
    impact_summary: '900+ companies qualified, 3 product matches each. Replaces 30 minutes of research per prospect.',
  ...
  // 12. Ambrosia Email Automation
  {
    ...
    client: 'Ambrosia',
    role: 'Developer',
    impact_summary: 'Campaign setup cut from 4 hours to 20 minutes. 7 customer segments fully automated.',
  ...
  // 14. User Discovery Automation
  {
    ...
    impact_summary: 'Feedback processing cut from 4 hours to 20 minutes. Every call auto-routed into Jira tickets.',
  ...
  // 15. LinkedIn Content Engine
  {
    ...
    impact_summary: '10+ hours saved every week on content. Auto-sourced topics with 3 ready-to-post drafts.',
  ...
  // 16. Patent Data Integration
  {
    ...
    client: 'Biotech Firm',
    role: 'Developer',
    impact_summary: 'Patent data entry cut from hours to minutes. Automated entity linking and dedup.',
  ...
  // 17. Foresight LinkedIn Content Engine
  {
    ...
    client: 'Foresight',
    role: 'Developer',
    impact_summary: 'Content production cut from 4-5 hours to 45 minutes.',
  ...
  // 18. Warm Intro Outreach
  {
    ...
    client: 'Zoefoundry',
    role: 'Developer',
    impact_summary: 'Warm-intro research cut from 2+ hours to minutes. Mutual connections mapped automatically.',
